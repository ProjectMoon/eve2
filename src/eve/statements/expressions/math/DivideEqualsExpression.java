...
public class DivideEqualsExpression extends ExpressionStatement implements EveStatement {
	private ExpressionStatement expr1, expr2;
	
	public DivideEqualsExpression(ExpressionStatement expr1, ExpressionStatement expr2) {
		this.expr1 = expr1;
		this.expr2 = expr2;
	}
	...
	public EveObject execute() {
		DivisionExpression divide = new DivisionExpression(expr1, expr2);
		UpdateVariableStatement update = new UpdateVariableStatement(expr1, divide);
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DivideEqualsExpression other = (DivideEqualsExpression) obj;
		if (expr1 == null) {
			if (other.expr1 != null)
				return false;
