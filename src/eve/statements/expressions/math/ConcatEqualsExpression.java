...
public class ConcatEqualsExpression extends ExpressionStatement implements EveStatement {
	private ExpressionStatement expr1, expr2;
	
	public ConcatEqualsExpression(ExpressionStatement expr1, ExpressionStatement expr2) {
		this.expr1 = expr1;
		this.expr2 = expr2;
	}
	...
	public EveObject execute() {
		ConcatExpression concat = new ConcatExpression(expr1, expr2);
		UpdateVariableStatement update = new UpdateVariableStatement(expr1, concat);
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ConcatEqualsExpression other = (ConcatEqualsExpression) obj;
		if (expr1 == null) {
			if (other.expr1 != null)
				return false;
