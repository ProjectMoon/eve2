...
public class ModulusEqualsExpression extends ExpressionStatement implements EveStatement {
	private ExpressionStatement expr1, expr2;
	
	public ModulusEqualsExpression(ExpressionStatement expr1, ExpressionStatement expr2) {
		this.expr1 = expr1;
		this.expr2 = expr2;
	}
	...
	public EveObject execute() {
		ModulusExpression mod = new ModulusExpression(expr1, expr2);
		UpdateVariableStatement update = new UpdateVariableStatement(expr1, mod);
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ModulusEqualsExpression other = (ModulusEqualsExpression) obj;
		if (expr1 == null) {
			if (other.expr1 != null)
				return false;
