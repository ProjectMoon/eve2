...
public class MinusEqualsExpression extends ExpressionStatement implements EveStatement {
	private ExpressionStatement expr1, expr2;
	
	public MinusEqualsExpression(ExpressionStatement expr1, ExpressionStatement expr2) {
		this.expr1 = expr1;
		this.expr2 = expr2;
	}
	...
	public EveObject execute() {
		MinusExpression minus = new MinusExpression(expr1, expr2);
		UpdateVariableStatement update = new UpdateVariableStatement(expr1, minus);
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MinusEqualsExpression other = (MinusEqualsExpression) obj;
		if (expr1 == null) {
			if (other.expr1 != null)
				return false;
