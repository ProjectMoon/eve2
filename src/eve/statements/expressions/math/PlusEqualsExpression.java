...
public class PlusEqualsExpression extends ExpressionStatement implements EveStatement {
	private ExpressionStatement expr1, expr2;
	
	public PlusEqualsExpression(ExpressionStatement expr1, ExpressionStatement expr2) {
		this.expr1 = expr1;
		this.expr2 = expr2;
	}
	...
	public EveObject execute() {
		PlusExpression plus = new PlusExpression(expr1, expr2);
		UpdateVariableStatement update = new UpdateVariableStatement(expr1, plus);
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PlusEqualsExpression other = (PlusEqualsExpression) obj;
		if (expr1 == null) {
			if (other.expr1 != null)
				return false;
