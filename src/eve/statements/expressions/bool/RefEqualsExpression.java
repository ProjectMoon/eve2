...
public class RefEqualsExpression extends ExpressionStatement implements EveStatement {
	private ExpressionStatement exp1, exp2;
	
	public RefEqualsExpression(ExpressionStatement exp1, ExpressionStatement exp2) {
		this.exp1 = exp1;
		this.exp2 = exp2;
	}
	...
	public EveObject execute() {
		...
		EveObject res = EveObjectFactory.create(op1 == op2);
		return res;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RefEqualsExpression other = (RefEqualsExpression) obj;
		if (exp1 == null) {
			if (other.exp1 != null)
				return false;
