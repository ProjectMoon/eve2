...
public class GreaterThanExpression extends ExpressionStatement implements EveStatement {
	private ExpressionStatement exp1, exp2;
	
	public GreaterThanExpression(ExpressionStatement exp1, ExpressionStatement exp2) {
		this.exp1 = exp1;
		this.exp2 = exp2;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		GreaterThanExpression other = (GreaterThanExpression) obj;
		if (exp1 == null) {
			if (other.exp1 != null)
				return false;
